...
export const TransformingSection = () => {
  ...
  return (
    <div className="h-full lg:h-screen max-w-[7xl]  mx-auto bg-white flex items-center justify-center ">
      <main
        //@ts-ignore
        ref={ref}
        className="container mx-auto px-4 py-8 lg:py-16 w-full max-w-[90vw] lg:max-w-[80vw] xl:max-w-[1440px]"
      >
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 mt-8 lg:mt-20 ">
          {cards.map((card, index) => (
            ...
            >
              <div className="p-6">
                ...
                <div className="relative mb-6 h-[30vh] sm:h-[25vh] lg:h-[218px]">
                ...
                <p className="text-base lg:text-[1.2vw] leading-7 text-gray-600">
                  {card.description}
                </p>
              </div>
            </div>
